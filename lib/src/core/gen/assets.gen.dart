...
class $AssetsAuthGen {
  ...
  /// File path: assets/auth/login_background_image.svg
  SvgGenImage get loginBackgroundImage =>
      const SvgGenImage('assets/auth/login_background_image.svg');

  /// File path: assets/auth/login_logo.png
  AssetGenImage get loginLogo =>
      const AssetGenImage('assets/auth/login_logo.png');

  /// File path: assets/auth/signup_background.svg
  SvgGenImage get signupBackground =>
      const SvgGenImage('assets/auth/signup_background.svg');

  /// List of all assets
  List<dynamic> get values =>
      [loginBackgroundImage, loginLogo, signupBackground];
}
